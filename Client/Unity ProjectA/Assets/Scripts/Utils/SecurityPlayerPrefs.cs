...
public class SecurityPlayerPrefs
{
    ...
    {
        // 8 바이트로 하고, 변경해서 쓸것
        byte[] saltBytes = new byte[] { 125, 16, 177, 58, 23, 121, 75, 9 };

        // 길이 상관 없고, 키를 만들기 위한 용도로 씀
        string randomSeedForKey = "5bd456fcb4aaa0!adfga=e649eba45adfs^3sf3506e4dc";

        // 길이 상관 없고, aes에 쓸 key 와 iv 를 만들 용도
        string randomSeedForValue = "2e323d+sa3d772sd578=9df84sdf1v34b5^bb5c706sd7saw";
